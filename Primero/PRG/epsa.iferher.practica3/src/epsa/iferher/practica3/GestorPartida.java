...
public class GestorPartida{
    ...
    public void menupartidas(Partida x){
        ...
        System.out.println("2.A�adir jugador a juego");
        ...
        switch(seleccion){
            ...
            break;
            case 2: System.out.println("Introduce el ID del usario a a�adir");
    ...
    public void  nuevojuego(){
        ...
        else{System.out.println("C�digo inv�lido");}
    }
    ...
    public void sancionar(Scanner tec){
        ...
        if(existe && !listajugadores[i-1].getSancionado()){
            ...
            System.out.println("Este jugador ya est� sancionado");
        }
    ...
    public void quitarsancion(Scanner tec){
        ...
        if(existe && listajugadores[i-1].getSancionado()){
            ...
            System.out.println("Este jugador ya est� sin sancionar");
        }
        else{System.out.println("No existe un jugador con esa ID");}
    ...
    public Juego selecc(Scanner tec){
        Juego juego = null;
        if(Juego.getNumjuegosact()==0){System.out.println("No hay ning�n juego activo");return juego;}
        else{
            ...
            else if (existe){System.out.println("Este juego no est� activo");}
    ...
    public void Jugar(Partida x){
        ...
        else if (x.getNumerojugadores()>x.getJuego().getMaxjugadores()){System.out.println("Hay m�s jugadores que el m�ximo, vuelve al menu para reiniciar las opciones de partida");menupartidas(x);}
        else if (x.getNumerojugadores()<x.getJuego().getMinjugadores()){System.out.println("Hay menos jugadores que el m�nimo,!A�ADE MAS!");menupartidas(x);}
        else {x.setIniciada(true);}
        System.out.println("Partida iniciada = "+x.isIniciada());
        Scanner tec = new Scanner(System.in);
        System.out.println("Felicidades, est�s jugando, cuando quieras parar de jugar escribe 0");
        while(true){
        int m = tec.nextInt();
        tec.nextLine();
        if (m==0){System.exit(0);}
        else{System.out.println("Ese n�mero no es 0");}
        }
    }   
}