...
public class Ordenacion {
    ...
    */
    ...
    public static <T extends Comparable<T>> void mergeSort2(T[] v) {
        T[]resultado=mergeSort2(v,0,v.length-1);
    ...
    private static <T extends Comparable<T>> T[] mergeSort2(T[] v,
        ...
        if(i<f){
            int medio = (i+f)/2;
            T[] v1 = mergeSort2(v,i,medio);
            T[] v2 = mergeSort2(v,medio+1,f);
            return merge2(v1,v2);
        }
        return v;
    }        
    ...
    private static <T extends Comparable<T>> T[] merge2(T[] v1, T[] v2) {
        ...
        for (int r = i; r < v1.length; r++) aux[k++] = v1[r];
        for (int r = j; r < v2.length; r++) aux[k++] = v2[r];
        return aux;
    }
